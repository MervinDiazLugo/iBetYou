              ...
              {amount >= 100 && (
                <div className="rounded-lg bg-muted p-3 text-sm space-y-1">
                  <div className="flex justify-between">
                    <span>Monto bruto</span><span>{amount.toFixed(2)} IBC</span>
                  </div>
                  <div className="flex justify-between text-muted-foreground">
                    <span>Fee (6%)</span><span>- {fee.toFixed(2)} IBC</span>
                  </div>
                  <div className="flex justify-between font-semibold border-t pt-1 mt-1">
                    <span>A recibir</span><span>{net.toFixed(2)} IBC</span>
                  </div>
                </div>
              )}
                  ...
                  <CardContent className="pt-4 pb-4">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-muted-foreground">Neto: {Number(req.net_amount).toFixed(2)} IBC</p>
