      ...
      <div className="flex items-center gap-1.5">
        <button
          ...
          title={
            ...
            : mode === "fantasy" ? "Cambiar a Modo Real (iBYC)"
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60">
          <div className="bg-card border border-border rounded-xl p-6 max-w-sm w-full mx-4 shadow-2xl">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              En Modo Real apostas con <span className="text-amber-400 font-semibold">iBYC</span> — moneda con valor real (1 iBYC = $1 USD). Las predicciones se descuentan de tu saldo iBYC.
            </p>
      ...
      {showBlocked && createPortal(
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60">
          <div className="bg-card border border-border rounded-xl p-6 max-w-sm w-full mx-4 shadow-2xl">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              El Modo Real con <span className="text-amber-400 font-semibold">iBYC</span> aún no está habilitado en tu país. Por ahora podés disfrutar del Modo Fantasy sin límites.
            </p>
